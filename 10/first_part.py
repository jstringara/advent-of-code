...
def compute_score(trails: list[list[tuple[int, int]]]) -> int:
    # find all the distinct final points
    final_points = set(trail[-1] for trail in trails)
...
my_scores = [compute_score(trail) for trail in my_trails.values()]
